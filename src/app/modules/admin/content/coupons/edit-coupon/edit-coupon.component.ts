...
export class EditCouponComponent implements OnInit, OnDestroy {
  ...
  constructor(public selectOptionService: SelectOptionService, public http: Http) {
    ...
    const couponCode = new FormControl('', Validators.required);
    const couponType = new FormControl('', Validators.required);
    const couponValue = new FormControl('', Validators.required);
    const couponValidFrom = new FormControl('', Validators.required);
    const couponValidTo = new FormControl('', Validators.required);
    const couponUsage = new FormControl('', Validators.required);
